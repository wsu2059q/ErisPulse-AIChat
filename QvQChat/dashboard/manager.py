...
class DashboardManager:
    ...
    I18N_KEYS = {
        ...
        "cfg.human_state.proactive_message.urge_threshold": ("QvQChat.cfg_human_state_proactive_message_urge_threshold", "冲动值门槛"),
        ...
        "cfg.human_state.proactive_message.max_per_day": ("QvQChat.cfg_human_state_proactive_message_max_per_day", "单会话每日上限"),
        "cfg.human_state.proactive_message.global_max_per_day": ("QvQChat.cfg_human_state_proactive_message_global_max_per_day", "全局每日上限"),
        "cfg.human_state.proactive_message.unanswered_cooldown_hours": ("QvQChat.cfg_human_state_proactive_message_unanswered_cooldown_hours", "没人理冷却(小时)"),
